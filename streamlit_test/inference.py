...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--checkpoint",
        dest="checkpoint",
        default="/Users/sinchan-yeob/streamlit_test/log/attention_50/checkpoints/0050.pth", # must change
        type=str,
    ...
    eval_dir = os.environ.get('SM_CHANNEL_EVAL', '/Users/sinchan-yeob/streamlit_test/data') # must change
    ...
    output_dir = os.environ.get('SM_OUTPUT_DATA_DIR', '/Users/sinchan-yeob/streamlit_test/submit') # must change
    parser.add_argument(
        "--output_dir",
        dest="output_dir",
        default=output_dir,
